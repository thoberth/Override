...
here we one main which do a cmp between ```0x149c``` 5276 in decimal and a int\
which has been enter in the prompt, if the cmp match there is a call to system with "/bin/sh" in argument

# give the good prompt
